      ...
      <div className="flex-1 min-w-0 pb-16">
        ...
        <div className="flex justify-between items-center pt-8">
          {prev ? (
            <Link
              href={prev.href}
              className="group flex flex-col gap-1 rounded-lg border p-3 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors w-full max-w-[40%]"
            >
              ...
              <div className="font-semibold text-sm text-foreground">{prev.title}</div>
            </Link>
          ) : (
            <div />
          )}
          ...
          {next && (
            <Link
              href={next.href}
              className="group flex flex-col gap-1 items-end rounded-lg border p-3 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors w-full max-w-[40%] text-right"
            >
              <div className="flex items-center gap-1 text-xs text-muted-foreground group-hover:text-foreground">
                Next
                <ChevronRight className="h-3 w-3 transition-transform group-hover:translate-x-1" />
              </div>
              <div className="font-semibold text-sm text-foreground">{next.title}</div>
            </Link>
          )}
        </div>
      </div>
